...
// You've already set TBAG_DAILY_BUYS_DEPLOY_BLOCK in Vercel.
...
const SAFE_DEPLOY_BLOCK = Number.isFinite(DEPLOY_BLOCK) ? DEPLOY_BLOCK : 0;
...
let cachedRows = null; // Array<{ wallet: string; totalBuys: number }>
let cachedAt = 0;
...
async function fetchLeaderboardFromChain() {
